      ...
      timer = setTimeout(async () => {
        ...
        try {
          ...
          if (isDev) {
            ...
            const a = `` // eslint-disable-line
          ...
          readModel.ecahList('sampList', readItem => {
            ...
            const samp: Port.SampItem = {
              ...
              U: readItem.read('U'),
              I: readItem.read('I'),
              vol: readItem.read('vol'),
              epower: readItem.read('epower'),
