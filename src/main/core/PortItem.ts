      ...
      timer = setTimeout(async () => {
        ...
        try {
          ...
          if (isDev) {
            ...
            const a = `` // eslint-disable-line
          ...
          readModel.ecahList('sampList', readItem => {
            ...
            if (
              ...
              if (lastStatus !== nowStatus) {
                ...
                const saveSampStatus = getProjectSamp(
                  projectId,
                  'changeStatusList'
                )
